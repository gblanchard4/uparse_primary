...
path = '/'.join(os.path.abspath(input_fasta).split('/')[:-1])+'/'
filename = 'derep_'+os.path.abspath(input_fasta).split('/')[-1]

# Write out our dereplicated fasta
output_fasta = path+filename
print 'Writing the output file: %s' % output_fasta
